...
function getHUVWindows(startDate) {
  ...
  // Calculate date windows (HOPE Protocol)
  // HUV1: Days 6 - 15
  huv1Start.setDate(socDate.getDate() + 6);
  huv1End.setDate(socDate.getDate() + 15);

  // HUV2: Days 16 - 30
  huv2Start.setDate(socDate.getDate() + 16);
  huv2End.setDate(socDate.getDate() + 30);
...
function testHUVCalculation() {
  const testDate = new Date('1/31/25');
